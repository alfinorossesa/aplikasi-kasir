...
<div class="col-12 col-md-12">
    <div class="app-card app-card-settings shadow-sm p-4">
        <div class="app-card-body">
            <form class="settings-form" action="{{ route('data-menu.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control  @error('nama_menu') is-invalid @enderror" id="nama_menu" name="nama_menu" value="{{ old('nama_menu') }}" required placeholder="Masukkan Nama Menu">
                    @error('nama_menu')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
